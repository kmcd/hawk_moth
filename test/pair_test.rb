...
class PairTest < Test::Unit::TestCase
  ...
  test "should have cumulative spread of zero on market open" do
    ...
    assert_equal 0.0, @pair.cumulative_spread_zscore("2011-11-14 09:30:00")
  end
  ...
  test "should calculate Z-score of cumulative spread price CHANGES" do
    ...
    assert_in_delta -0.7071, @pair.cumulative_spread_zscore("2011-11-14 09:31:00"), 0.0001
  end
  ...
  test "should calculate Z-score of cumulative spread running total" do
    ...
    assert_in_delta -1.0384, @pair.cumulative_spread_zscore("2011-11-14 09:32:00"), 0.0001
  end
  ...
  test "should only use current day for spread calculations" do
    ...
    assert_equal 0.0, @pair.cumulative_spread_zscore("2011-11-15 09:30:00")
  end
  ...
  test "should ignore missing bars" do
    ...
    assert_in_delta -0.7071, @pair.cumulative_spread_zscore("2011-11-14 09:32:00"), 0.0001
  end
  
  test "should detect a high/low spread Z-score" do
    load_fixtures
    
    assert_in_delta -2.7358, @pair.cumulative_spread_zscore("2011-07-08 10:59:00"), 0.0001
